package com.myatos.net.user.service.implementation;

import com.myatos.net.user.configuration.JiraClientConfiguration;
import com.myatos.net.user.client.ProjectClient;
import com.myatos.net.user.dto.site.AddSiteRequest;
import com.myatos.net.user.dto.site.AssignSiteRequest;
import com.myatos.net.user.dto.site.SiteProjectSummary;
import com.myatos.net.user.dto.site.SiteResponse;
import com.myatos.net.user.dto.user.JiraUserResponse;
import com.myatos.net.user.enums.JiraApiEndpoint;
import com.myatos.net.user.exception.ConflictException;
import com.myatos.net.user.exception.NotFoundException;
import com.myatos.net.user.mapper.SiteMapper;
import com.myatos.net.user.model.helper.JiraUrlBuilder;
import com.myatos.net.user.model.project.ProjectSearchPage;
import com.myatos.net.user.model.project.ProjectSummary;
import com.myatos.net.user.model.site.Site;
import com.myatos.net.user.model.site.SiteProject;
import com.myatos.net.user.model.site.SiteURLUtility;
import com.myatos.net.user.model.site.UserSite;
import com.myatos.net.user.model.user.User;
import com.myatos.net.user.repository.SiteProjectRepository;
import com.myatos.net.user.repository.SiteRepository;
import com.myatos.net.user.repository.UserRepository;
import com.myatos.net.user.repository.UserSiteRepository;
import com.myatos.net.user.service.EncryptionService;
import com.myatos.net.user.service.JiraUserService;
import com.myatos.net.user.service.SiteService;
   ...
   ========================= */
    ...
    private void assertCurrentUserIsAdmin() {
        ...
        if (currentUser.getRoles() == null
                || !currentUser.getRoles().contains(com.myatos.net.user.enums.Role.ADMIN)) {

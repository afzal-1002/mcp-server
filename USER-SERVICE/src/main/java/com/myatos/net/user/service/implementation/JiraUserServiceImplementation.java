...
import com.myatos.net.user.model.helper.HelperMethod;
...
import com.myatos.net.user.repository.UserCredentialRepository;
import com.myatos.net.user.service.AppUserService;
import com.myatos.net.user.service.CredentialService;

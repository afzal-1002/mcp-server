...
import com.myatos.net.issues.client.ProjectClient;
import com.myatos.net.issues.dto.helper.HelperMethod;
import com.myatos.net.issues.dto.issue.CreateIssueRequest;
import com.myatos.net.issues.dto.issue.request.JqlSearchRequest;
import com.myatos.net.issues.dto.issue.response.Issuereponse.*;
import com.myatos.net.issues.dto.issue.response.IssueResponseSummary;
import com.myatos.net.issues.dto.issue.response.Issuereponse.CommentResponse;
import com.myatos.net.issues.dto.issue.response.Issuereponse.IssueFields;
import com.myatos.net.issues.dto.issue.response.Issuereponse.IssueResponse;
import com.myatos.net.issues.dto.issue.response.Issuereponse.ProjectSummary;
import com.myatos.net.issues.dto.issuetype.IssueTypeReference;
import com.myatos.net.issues.dto.project.ProjectReference;
import com.myatos.net.issues.dto.project.ProjectResponse;
import com.myatos.net.issues.dto.project.SyncProjectRequest;
import com.myatos.net.issues.dto.user.UserReference;
import com.myatos.net.issues.enums.SynchronizationStatus;
import com.myatos.net.issues.exception.ProjectNotFoundException;
import com.myatos.net.issues.exception.ResourceNotFoundException;
import com.myatos.net.issues.mapper.IssueMapper;
import com.myatos.net.issues.dto.helper.JiraUrlBuilder;
import com.myatos.net.issues.dto.issue.CreateIssueFields;
import com.myatos.net.issues.model.issue.Issue;
import com.myatos.net.issues.model.issue.IssueTimeTracking;
import com.myatos.net.issues.model.issuetype.IssueType;
import com.myatos.net.issues.repository.IssueRepository;
import com.myatos.net.issues.service.*;
import com.myatos.net.issues.service.IssueService;
import com.myatos.net.issues.service.IssueTypeService;
import com.myatos.net.issues.service.JiraCommentService;
import com.myatos.net.issues.service.JiraIssueService;
